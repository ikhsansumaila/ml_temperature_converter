...
class TempSlider extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Stack(children: [
      ...
      Container(color: Color.fromRGBO((tempValue.toInt() + 75), 0, 255 - (tempValue.toInt() + 75), 1)),
              ...
              child: Column(
                ...
                children: [
                  const Icon(Icons.swipe_vertical, size: 40, color: Colors.white)
                      ...
                      .slideY(begin: 0.5, end: 0, duration: 1.seconds, curve: Curves.easeInOut)
                      .fadeIn(),
                  const SizedBox(height: 30),
                  const Text('Drag up and down the screen\nto change temperature',
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Text('${tempValue.toInt()}°c', style: const TextStyle(fontSize: 90, color: Colors.white)),
          ],
        ),
      ],
    );
